...
namespace MinimizeAppSomething
{
    ...
    {
        private static readonly int _readDelay = 33;
            ...
            await Task.Run(async () =>
            {
                ...
                while (true)
                {
                    ...
                    if (BaseAddresses.GeneralData.OsuStatus == OsuMemoryStatus.Playing &&
                        _lastStatus != OsuMemoryStatus.Playing)
                        MinimizeProgram();
                    else if (BaseAddresses.GeneralData.OsuStatus != OsuMemoryStatus.Playing &&
                             _lastStatus == OsuMemoryStatus.Playing)
                        MaximizeProgram();
        ...
        private static void MinimizeProgram()
        {
            ...
            if (p != null) ShowWindow(p.MainWindowHandle, (int) ShowWindowEnum.ShowMinimized);
        }
        ...
        private static void MaximizeProgram()
        {
            ...
            if (p != null) ShowWindow(p.MainWindowHandle, (int) ShowWindowEnum.ShowNormalNoActivate);
        }
