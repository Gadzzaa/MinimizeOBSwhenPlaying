...
namespace OsuHG
{
    public class SettingsMenu
    {
        ...
        public static void SelectNumber(int x)
        {
            ...
            for (int i = 0; i <= 5; i++)
            {
                if (Int32.Parse(Console.ReadLine())!=i) return;
                x = i-1;
                break;
            }
        }
        ...
        public static void Option()
        {
            ...
            if (2 * x == 6) Settings1.Default.lowGamma = Int32.Parse(Console.ReadLine());
            if (2 * x == 8) Settings1.Default.highGamma = Int32.Parse(Console.ReadLine());
            ConsoleClearV2.Clear();
        }
